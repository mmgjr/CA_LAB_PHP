...
<form method="POST">
	...
	<textarea name="internal_obs" id="internal_obs"><?php echo $client_info['internal_obs'];?>
	</textarea><br><br>
	
	<label for="address_zipcode">CEP:</label><br>
	<input type="text" name="address_zipcode" id="address_zipcode" value="<?php echo $client_info['address_zipcode'];?>" ><br><br>
	...
	<input type="text" name="address_neigh" value="<?php echo $client_info['address_neigh'];?>" ><br><br>
